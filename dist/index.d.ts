...
}declare module 'ts-inversify-lib/node_modules/reflect-metadata/index' {
	/*! *****************************************************************************
...
declare module 'ts-inversify-lib/node_modules/inversify/dts/constants/metadata_keys' {
...
declare module 'ts-inversify-lib/node_modules/inversify/dts/interfaces/interfaces' {
...
declare module 'ts-inversify-lib/node_modules/inversify/dts/container/container' {
	import { interfaces } from "../interfaces/interfaces"; class Container implements interfaces.Container {
	    id: number;
...
declare module 'ts-inversify-lib/node_modules/inversify/dts/constants/literal_types' {
	import { interfaces } from "../interfaces/interfaces"; const BindingScopeEnum: interfaces.BindingScopeEnum; const BindingTypeEnum: interfaces.BindingTypeEnum; const TargetTypeEnum: interfaces.TargetTypeEnum;
	export { BindingScopeEnum, BindingTypeEnum, TargetTypeEnum };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/container/container_module' {
...
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/injectable' {
	 function injectable(): (target: any) => any;
	export { injectable };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/tagged' {
	 function tagged(metadataKey: string | number | symbol, metadataValue: any): (target: any, targetKey: string, index?: number | undefined) => void;
	export { tagged };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/named' {
	 function named(name: string | number | symbol): (target: any, targetKey: string, index?: number | undefined) => void;
	export { named };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/inject' {
	import { interfaces } from "../interfaces/interfaces";
	...
	} function inject(serviceIdentifier: ServiceIdentifierOrFunc): (target: any, targetKey: string, index?: number | undefined) => void;
	export { inject };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/optional' {
	 function optional(): (target: any, targetKey: string, index?: number | undefined) => void;
	export { optional };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/unmanaged' {
	 function unmanaged(): (target: any, targetKey: string, index: number) => void;
	export { unmanaged };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/multi_inject' {
	import { interfaces } from "../interfaces/interfaces"; function multiInject(serviceIdentifier: interfaces.ServiceIdentifier<any>): (target: any, targetKey: string, index?: number | undefined) => void;
	export { multiInject };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/target_name' {
	 function targetName(name: string): (target: any, targetKey: string, index: number) => void;
	export { targetName };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/post_construct' {
	 function postConstruct(): (target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
	export { postConstruct };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/planning/metadata_reader' {
	import { interfaces } from "../interfaces/interfaces"; class MetadataReader implements interfaces.MetadataReader {
...
declare module 'ts-inversify-lib/node_modules/inversify/dts/utils/id' {
	 function id(): number;
	export { id };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/annotation/decorator_utils' {
	import { interfaces } from "../interfaces/interfaces"; function tagParameter(annotationTarget: any, propertyName: string, parameterIndex: number, metadata: interfaces.Metadata): void; function tagProperty(annotationTarget: any, propertyName: string, metadata: interfaces.Metadata): void; function decorate(decorator: (ClassDecorator | ParameterDecorator | MethodDecorator), target: any, parameterIndex?: number | string): void;
	export { decorate, tagParameter, tagProperty };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/syntax/constraint_helpers' {
	import { interfaces } from "../interfaces/interfaces"; const traverseAncerstors: (request: interfaces.Request, constraint: interfaces.ConstraintFunction) => boolean; const taggedConstraint: (key: PropertyKey) => (value: any) => interfaces.ConstraintFunction; const namedConstraint: (value: any) => interfaces.ConstraintFunction; const typeConstraint: (type: string | Function) => (request: interfaces.Request | null) => boolean;
	export { traverseAncerstors, taggedConstraint, namedConstraint, typeConstraint };

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/utils/serialization' {
	import { interfaces } from "../interfaces/interfaces"; function getServiceIdentifierAsString(serviceIdentifier: interfaces.ServiceIdentifier<any>): string; function listRegisteredBindingsForServiceIdentifier(container: interfaces.Container, serviceIdentifier: string, getBindings: <T>(container: interfaces.Container, serviceIdentifier: interfaces.ServiceIdentifier<T>) => interfaces.Binding<T>[]): string; function circularDependencyToException(request: interfaces.Request): void; function listMetadataForTarget(serviceIdentifierString: string, target: interfaces.Target): string; function getFunctionName(v: any): string;
...
declare module 'ts-inversify-lib/node_modules/inversify/dts/utils/binding_utils' {
	import { interfaces } from "../inversify";
	export const multiBindToService: (container: interfaces.Container) => (service: string | symbol | interfaces.Newable<any> | interfaces.Abstract<any>) => (...types: (string | symbol | interfaces.Newable<any> | interfaces.Abstract<any>)[]) => void;

}
declare module 'ts-inversify-lib/node_modules/inversify/dts/inversify' {
	import * as keys from "./constants/metadata_keys";
	export const METADATA_KEY: typeof keys;
...
declare module 'ts-inversify-lib/src/models/Record' {
	export default class Record {
	}

}
declare module 'ts-inversify-lib/src/models/Response' {
	import Record from 'ts-inversify-lib/src/models/Record';
...
declare module 'ts-inversify-lib/src/models/Request' {
...
declare module 'ts-inversify-lib/src/repository/interface/IDataRepository' {
	import Response from 'ts-inversify-lib/src/models/Response';
	import Request from 'ts-inversify-lib/src/models/Request';
...
declare module 'ts-inversify-lib/src/repository/implementation/MongoDataRepository' {
	import IDataRepository from 'ts-inversify-lib/src/repository/interface/IDataRepository';
	import Response from 'ts-inversify-lib/src/models/Response';
	import Request from 'ts-inversify-lib/src/models/Request';
...
declare module 'ts-inversify-lib/src/repository/implementation/SqlDataRepository' {
	import IDataRepository from 'ts-inversify-lib/src/repository/interface/IDataRepository';
	import Response from 'ts-inversify-lib/src/models/Response';
	import Request from 'ts-inversify-lib/src/models/Request';
...
declare module 'ts-inversify-lib/src/service/interface/IService' {
	import Request from 'ts-inversify-lib/src/models/Request';
	import Response from 'ts-inversify-lib/src/models/Response';
...
declare module 'ts-inversify-lib/src/service/implementation/Service' {
	import IDataRepository from 'ts-inversify-lib/src/repository/interface/IDataRepository';
	import IService from 'ts-inversify-lib/src/service/interface/IService';
	import Request from 'ts-inversify-lib/src/models/Request';
	import Response from 'ts-inversify-lib/src/models/Response';
...
declare module 'ts-inversify-lib/src/index' {
	 const _default: {};
	export = _default;
